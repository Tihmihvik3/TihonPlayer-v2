...
class HotkeysManager:
    ...
    def register_hotkeys(self):
        ...
        keyboard.add_hotkey('page up', lambda: wx.CallAfter(self.execute_if_active, self.tab.on_prev_track))
        keyboard.add_hotkey('page down', lambda: wx.CallAfter(self.execute_if_active, self.tab.on_next_track))
        ...
        keyboard.add_hotkey('shift+down', lambda: wx.CallAfter(self.execute_if_active, self.tab.on_pitch_down, None))
        keyboard.add_hotkey('shift+up', lambda: wx.CallAfter(self.execute_if_active, self.tab.on_pitch_up, None))
